...
STYLE_KEYS=['music','music_volume','music_fade','sfx','sticker','sticker_start','sticker_end','overlays','lut','color','font_size','caption_mode','caption_style','keywords','filter','transition','zoom','captions_enabled','aspect','quality','titles','normalize_audio','denoise']
def project():
