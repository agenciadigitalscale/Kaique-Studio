...
FILTERS = {
    ...
    'Alto contraste': 'eq=contrast=1.3:saturation=1.1',
    'Clarear': 'eq=brightness=0.08:contrast=1.03',
    'Escurecer': 'eq=brightness=-0.06:contrast=1.06',
    'Teal & Orange': 'curves=preset=medium_contrast,eq=saturation=1.12,colorbalance=rs=0.06:bs=-0.06:rm=0.04:bm=-0.05',
    'VHS retrô': 'noise=alls=8:allf=t,eq=saturation=1.1:contrast=1.05',
    'Verão': 'eq=saturation=1.2:gamma_r=1.05:gamma_g=1.02:brightness=0.03',
    'Outono': 'eq=saturation=1.1:gamma_r=1.06:gamma_b=0.92',
    'Frio azulado': 'eq=saturation=1.02:gamma_b=1.1:gamma_r=0.92:brightness=0.01',
    'Quente dourado': 'eq=saturation=1.1:gamma_r=1.08:gamma_g=1.02:gamma_b=0.9',
    'Pastel': 'eq=saturation=0.85:contrast=0.95:brightness=0.05',
    'Dramático': 'eq=contrast=1.25:saturation=0.95:brightness=-0.02,vignette=PI/5',
    'Nítido forte': 'unsharp=7:7:1.2:7:7:0.0',
